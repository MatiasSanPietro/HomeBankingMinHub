namespace HomeBankingMinHub.Models
{
    public class DbInitializer
    {
        ...
        {
            //
            // AL CARGAR LOS DATOS YA DEBE ESTAR CREADA LA CUENTA DE vcoronado@gmail.com USANDO EL REGISTER
            // PARA QUE LA CONTRASEÑA ESTE HASHEADA. (Comentar todo el initializer, hacer la cuenta y despues
            // correr la aplicacion denuevo con el dbinitializer descomentado).
            //
            ...
            if (!context.Loans.Any())
            {
                ...
                var client1 = context.Clients.FirstOrDefault(c => c.Id == 1);
                if (client1 != null)
                {
